...
//            Exceptions.tr(DataProviderException.class, "message.sql.op.forbidden", sql);
            Exceptions.tr(DataProviderException.class, String.format("You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near '%s'", sql), sql);
        }
        // special sql
        if (!enableSpecialSQL) {
//            Exceptions.tr(DataProviderException.class, "message.sql.op.forbidden", sql);
