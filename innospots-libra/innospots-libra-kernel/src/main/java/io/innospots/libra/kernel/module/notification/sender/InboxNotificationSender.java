 ...
 * @date 2022/4/26
 */
public class InboxNotificationSender implements INotificationSender {

    private final NotificationMessageOperator notificationMessageOperator;

    public InboxNotificationSender(NotificationMessageOperator notificationMessageOperator) {
    ...
    public void send(NotificationMessageEntity messageLog, UserInfo userInfo) {
        notificationMessageOperator.save(messageLog);
    }
}
