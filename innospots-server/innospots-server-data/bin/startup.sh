...
#Spring profile
export PROFILE="dev"
export SERVER_MAIN_CLASS="io.innospots.data.server.InnospotDataServer"
...
if [[ "${PROFILE}" == "dev" ]]; then
  JAVA_OPT="-Xms128m -Xmx1g -Xss256k"
else
  JAVA_OPT="-Xms2g -Xmx2g -Xss256k -Xmn1g -XX:MetaspaceSize=128m -XX:MaxMetaspaceSize=320m"
